...
public {0} {1}({2})
{
        ...
        _getPropertyStr(pObj) {
            return this._format(this._propertyTemplate, pObj.type, pObj.name);            
        }
        
        _getMethodStr(mObj) {
             var aStr = "";
            if(mObj.args.length > 0){                
                for(var c = 0; c < mObj.args.length; c++){
                    aStr += mObj.type + " " + mObj.name;                    
                    if(c < mObj.args.length-1) aStr += ", ";
                }
            }
            return this._format(this._methodTemplate, mObj.returnType, mObj.name, aStr);            
        }
    ...
    wbi.i = class {
        ...
        _getUnityCSharpInterface() {
            var iUC = new wbi.iUnityWebView;
            return(iUC._getInterface(this._getInterface()));
        }
    };
